...
const API_GATEWAY_ID = "2m5ocdhp3a"
const SOCKET_API_GATEWAY_ID = "0kec5cxk2l"
const REGION_CONFIG  = "ap-northeast-2"
class App extends Component {
  ...
  connectToWebScoket = () => {
    const address = `wss://${SOCKET_API_GATEWAY_ID}.execute-api.${REGION_CONFIG}.amazonaws.com/dev?user_id=test&room_id=test`
  ...
  componentDidMount = async () => {
    ...
    const result = await axios({
      method: 'GET',
      url: `https://${API_GATEWAY_ID}.execute-api.${REGION_CONFIG}.amazonaws.com/dev/chat`,
      params: {
        room_id: "test"
      }
    });;
